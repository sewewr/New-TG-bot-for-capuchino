...
Перед началом работы с ботом, пожалуйста, ознакомьтесь с условиями обработки персональных данных.

<b>1. Какие данные мы собираем</b>
В процессе регистрации вы предоставляете:
• ФИО
...
• Идентификации сотрудника в системе обучения
• Отслеживания прогресса обучения
• Связи с сотрудником по вопросам работы
• Формирования карточки сотрудника для руководителя

<b>3. Хранение и защита</b>
• Данные хранятся на защищённом сервере
• Не передаются третьим лицам
• Срок хранения — период трудовой деятельности + 30 дней

<b>4. Ваши права</b>
Вы вправе в любой момент запросить удаление своих данных, написав команду /delete

<b>5. Согласие</b>
Нажимая «Принимаю соглашение», вы подтверждаете своё согласие на обработку персональных данных в соответствии с настоящим соглашением и Федеральным законом №152-ФЗ «О персональных данных».
""".strip()
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        "Здесь вы пройдёте обучение для должности <b>Продавец</b> и подготовитесь "
